...
class MBConvBlock(nn.Module):
    ...
    def __init__(self, block_args, global_params, image_size=None, normalization_factory=None):
        super().__init__()
        ...
        if self._block_args.expand_ratio != 1:
            ...
            self._bn0 = normalization_factory.create_norm2d(oup)
        ...
        self._bn1 = normalization_factory.create_norm2d(oup)
        ...
        self._bn2 = normalization_factory.create_norm2d(final_oup)
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None, normalization_args=None):
        super().__init__()
        ...
        self._bn0 = self.normalization_factory.create_norm2d(out_channels)
    ...
    @classmethod
    def from_name(cls, model_name, in_channels=3, normalization_args=None, **override_params):
        ...
        model = cls(blocks_args, global_params, normalization_args)
